...
using DSM.Services.KeyboardService;
...
namespace DSM.Common
{
    ...
    public abstract class BootStrapper : Application
    {
        ...
        private async void InternalLaunchAsync(ILaunchActivatedEventArgs e)
        {
            ...
            NavigationService.NavigationFinished += NavigationService_NavigationFinished;
            // expire state
            ...
            Window.Current.SetTitleBar(new Button() {Content = "Hello"});
            // ensure active
            Window.Current.Activate();
        ...
        private void NavigationService_NavigationFinished(object sender, EventArgs e)
        {
